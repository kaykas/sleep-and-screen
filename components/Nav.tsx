          ...
          <div className="h-16 flex items-center gap-4">
            ...
            <Link href="/" className="flex flex-col leading-none flex-shrink-0">
              <div className="flex items-baseline">
                <span className="text-xl font-black tracking-tight leading-none text-[#dc2626]">
                  East Bay
                </span>
                <span className="text-xl font-black tracking-tight leading-none text-[#1d4ed8] ml-1.5">
                  Mattress
                </span>
              </div>
              <span className="text-[10px] text-gray-400 font-medium tracking-wide mt-px hidden lg:block">
