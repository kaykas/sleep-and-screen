...
const screenings = [
  {
    ...
    runtime: "89 min",
    rating: "NR",
    series: "Damaged Americana",
    description:
      "Small-town Ohio after a tornado. Kids wander. Cats disappear. A rabbit is cooked. Harmony Korine's debut is still the most disquieting American film of its decade.",
  ...
  },
  {
    ...
    runtime: "89 min",
    rating: "NR",
    series: "Midnight Standards",
    description:
      "Henry Spencer navigates a surreal industrial nightmare while caring for his severely deformed child. Lynch's first feature. Still unclassifiable.",
    note: null,
    seats: 8,
    maxSeats: 12,
    tag: "midnight",
  },
  {
    ...
    runtime: "96 min",
    rating: "NR",
    series: "Female Directors / Female Monsters",
    description:
      "A Belgian-French vampire film of unusual elegance. Two newlyweds at a deserted hotel. A countess and her companion. Things are not what they appear.",
    note: null,
    seats: 11,
    maxSeats: 12,
    tag: "arthouse",
  },
  {
    ...
    runtime: "107 min",
    rating: "R",
    series: "Machine Nights",
    description:
      "A machine from the future arrives in 1984 Los Angeles to kill a woman whose unborn son will lead the human resistance. Before the franchise. Before the CGI. Just a killer and a city.",
    note: `${CURATOR.firstName}'s Pick`,
    seats: 2,
    maxSeats: 12,
    tag: "action",
  },
  {
    ...
    series: "Body Trouble",
    description:
      "A marriage collapses in Cold War Berlin. Sam Neill and Isabelle Adjani disintegrate in parallel. One of them is also meeting something in a subway. Adjani won Cannes. We understand why.",
    note: null,
    seats: 6,
    maxSeats: 12,
    tag: "body horror",
